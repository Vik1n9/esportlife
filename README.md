...
> 規格書已升到 v4.3.1（v4.3：生命週期曲線、訓練事件卡、特質重建、市場淘汰；v4.3.1：編輯器整合、四池管理、訓練邊界廢除）。v4.3 新增 **S15b 生命週期曲線站**（統一成長與衰退曲線，30 站變 31 站）。丁組下一站是 S15b（規格 §7.2 已定案，站說明書待寫）；docs/v4 狀態表與 S16 說明書尚未跟進 v4.3。