...
export const TRAINING_CARDS = [
  ...
  { id: 'tr_mechanics_success', tier: 'success', weight: 10, activity: ['mechanics'],
    text: '個人機械訓練按表操課，連招與走位的手感穩定。',
    effects: {} },
  { id: 'tr_mechanics_failure', tier: 'failure', weight: 10, activity: ['mechanics'],
    text: '機械訓練做得卡卡，技能施放節奏抓不準，越練越急。',
    effects: {} },
  { id: 'tr_mechanics_great_success', tier: 'great_success', weight: 3, activity: ['mechanics'],
    text: '狀態絕佳，連招行雲流水，訓練師說這個手感可以直接搬上比賽。',
    effects: { mental: { conf: 3, drive: 3 } } },
  { id: 'tr_mechanics_great_failure', tier: 'great_failure', weight: 3, activity: ['mechanics'],
  ...
  { id: 'tr_heroes_success', tier: 'success', weight: 10, activity: ['heroes'],
    text: '英雄池練習穩定推進，幾隻英雄的熟練度都看得出進步。',
    effects: {} },
  { id: 'tr_heroes_failure', tier: 'failure', weight: 10, activity: ['heroes'],
    text: '新練的英雄怎麼打都不順，連最基本的連招都會斷。',
    effects: {} },
  { id: 'tr_heroes_great_success', tier: 'great_success', weight: 3, activity: ['heroes'],
    text: '新英雄上手神速，幾場就打出教學局的水平，隊友直呼撿到寶。',
    effects: { mental: { drive: 3, conf: 3 } } },
  { id: 'tr_heroes_great_failure', tier: 'great_failure', weight: 3, activity: ['heroes'],
    text: '練了整晚的英雄還是練不起來，開始懷疑是不是自己上限就到這。',
    effects: { mental: { conf: -3 } } },

  // ══════════════ PRO 20：低體力危險 4 ＋ 高體力獎勵 4 ＋ 一般 12 ══════════════

  { id: 'tr_pro_low_mech', tier: 'great_failure', weight: 10, activity: ['mechanics'], stage: ['PRO'], stamina: [0, 39],
  ...
  { id: 'tr_pro_high_mech', tier: 'great_success', weight: 3, activity: ['mechanics'], stage: ['PRO'], stamina: [70, 100],
  ...
  { id: 'tr_pro_mech_form', tier: 'success', weight: 8, activity: ['mechanics'], stage: ['PRO'],
    text: '訓練師拿數據分析你的機械練習，指出出裝節奏的微調空間——職業隊的訓練就是細到這種程度。',
    effects: { attr: { tec: 1 } } },
  { id: 'tr_pro_mech_slump', tier: 'failure', weight: 8, activity: ['mechanics'], stage: ['PRO'],
  ...
  { id: 'tr_pro_soloq_meme', tier: 'failure', weight: 8, activity: ['soloq'], stage: ['PRO'],
    ...
    effects: { attr: { agi: -1 } } },
  { id: 'tr_pro_hero_plan', tier: 'success', weight: 8, activity: ['heroes'], stage: ['PRO'],
    text: '教練組替你定了三隻新英雄的練習計畫，進度順利，數據分析師都說熟練度曲線漂亮。',
    effects: {} },
  { id: 'tr_pro_hero_meta', tier: 'failure', weight: 8, activity: ['heroes'], stage: ['PRO'],
    text: '苦練的新英雄被版本一刀砍廢，教練說換一隻，白練的感覺不好受。',
    effects: {} },

  // ══════════════ AM2 8：青訓次級，attr ±1、無 injury、心理 ±3 ══════════════

  { id: 'tr_am2_mech_win', tier: 'great_success', weight: 6, activity: ['mechanics'], stage: ['AM2'],
    text: '青訓教練單獨指導你對線細節，幾個小習慣一改，對線立刻壓住對手。',
    effects: { mental: { conf: 3 }, attr: { tec: 1 } } },
  { id: 'tr_am2_mech_loss', tier: 'great_failure', weight: 6, activity: ['mechanics'], stage: ['AM2'],
  ...
  { id: 'tr_am2_hero_win', tier: 'great_success', weight: 6, activity: ['heroes'], stage: ['AM2'],
    text: '偷偷練成一手絕活英雄，青訓賽上一拿出來就打出教學局。',
    effects: { mental: { drive: 3 } } },

  // ══════════════ 業餘 8：網咖期，規則同 AM2（nobody 不變式紅線） ══════════════

  { id: 'tr_am_mech_win', tier: 'great_success', weight: 6, activity: ['mechanics'], stage: ['AMATEUR'],
    text: '網咖老闆看你打了一下午，說「你操作進步神速，下次業餘賽你來打中單」。',
    effects: { mental: { conf: 3 }, attr: { tec: 1 } } },
  { id: 'tr_am_mech_loss', tier: 'great_failure', weight: 6, activity: ['mechanics'], stage: ['AMATEUR'],
  ...
  { id: 'tr_am_soloq_win', tier: 'great_success', weight: 6, activity: ['soloq'], stage: ['AMATEUR'],
    ...
    effects: { mental: { conf: 3 }, attr: { tec: 1 } } },
  { id: 'tr_am_hero_win', tier: 'great_success', weight: 6, activity: ['heroes'], stage: ['AMATEUR'],
