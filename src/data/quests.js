...
export const QUEST_CARDS = [
  ...
  },
  {
    ...
    trigger: ['and', ['stat', 'assistsPerGame', 'gte', 2.5], ['stat', 'awards', 'eq', 0]],
    goal: ['and', ['stat', 'assistsPerGame', 'gte', 2.5], ['stat', 'proYears', 'gte', 7]],
    deadline: null,
    result: { tier: 'epic', key: 'helper', label: '究極綠葉' },
    failLabel: '被遺忘的綠葉',
    goalText: '達成目標：生涯場均助攻 ≥ 2.5，且職業年資 ≥ 7 年',
    materialText: null,
  },
  {
    id: 'route-influencer',
    ...
    trigger: ['and', ['stat', 'fameLevel', 'gte', 3], ['stat', 'careerScore', 'lt', 1200]],
    goal: ['and', ['stat', 'fameLevel', 'eq', 4], ['stat', 'awards', 'lte', 2], ['stat', 'careerScore', 'lt', 1200]],
    deadline: null,
    result: { tier: 'epic', key: 'showman', label: '網紅選手' },
    failLabel: '過氣網紅',
    goalText: '達成目標：知名度達「全民認識」，且生涯獎項 ≤ 2、生涯評分 < 1200',
    materialText: null,
  },
];
